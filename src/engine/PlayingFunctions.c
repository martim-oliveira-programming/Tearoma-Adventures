...
Player character_creation(void) {
    ...
    say("Select a build for your character:\n");
...
Player play_chapter(Player main_character, Story *story, int *chapter_npc_ids) {
    ...
    case Chapter_1:{
        ...
        if(strcmp(choice,"Dad")== 0){
            ...
            if (strcmp(choice,"Yes")== 0){
                say("You get closer and confirm your previous assessment was correct and help the lady with her bags.\nOld Lady-- Thank you so much for the help %s, here is a gift.\n-- Thank you for all your help.\n",gender_to_string(main_character.gender));
                sleep(5);
                say("'You received two chicken sandwiches'.\n");
                main_character = add_inventory(main_character,0,2);//Chicken Sandwich
                main_character.GOODNESS +=2;
                sleep(5);
                say("%s-- Thank You so much. I really need to get going now. Goodbye!\n--I hope I'm not to late...\n",main_character.name);
            }
            else if (strcmp(choice,"No")== 0){
                sleep(5);
                say("You decide not to help the lady and keep going as fast as you can.\nAs you walk away you hear the lady mumbling something about a curse and bad luck.\nYou feel a bit guilty but you have to find your Dad. You hope she is ok but you don't have time to loose.\n");
                main_character.GOODNESS -=2;
            }

            sleep(5);
            say("You finally reach the mine's entrance. It's a big cave in the side of a mountain with some mining equipment outside.\n");
            sleep(5);
            say("Uppon arival, you check the premesis for an entrance but the place seems to have a metal fence all around.\n\n");
            ...
            if (strcmp(choice, "Cut") == 0) { 
                sleep(2);
                say("You try to cut the fence but get zapped by it and fall to the ground.\n");
                main_character.HP -= 10;
                main_character.HUNGER += 20;
                main_character.GOODNESS -= 4;
                sleep(5);
                say("You wake up next to the security guards.\nThey tell you that you can't be here and that they will have to take you to the police station.\n");
            }
            else if (strcmp(choice, "Ask") == 0) {
                sleep(2);
                say("You approach the security guards' desk.\n");
                main_character.GOODNESS += 1;
            }
            sleep(5);
            main_character = add_inventory(main_character,1, 1); //Flashlight
            say("You explain the situation to the security guards and ask if you can go in to look for your Dad.\n");
            sleep(6);
            say("Reluctantly they let you in and one of them comes with you.\nThe guard gives you a flashlight to proceed with your search.\nAs you advance in the tunnels, you start to see a purple light that illuminates the cave.\n");
            sleep(6);
            say("'You recieved 1 Flashlight'.\n");
            sleep(5);
            say("Security Guard-- I don't think we should keep going. It can get dangerous and we aren't suposed to be here anyway!\n%s-- Maybe but this light is really weird and we came this far...\n",main_character.name);
            sleep(6);
            say("Security Guard-- Fine but if anything happens I'm leaving you here! I can't get in trouble.\n%s-- Deal.\n",main_character.name);
            say("You keep going and the light gets stronger and stronger until you reach a big cavern where you see a group of people trying to remove a big rock off what seems to be the light's source.\n");
            sleep(5);
            say("%s-- Excuse me! What are you doing?\nMiner-- Some of our crew entered what looked like some kind of secret passage when this giant rock fell and trapped them inside. We are trying to get them out.\n",main_character.name);
            sleep(5);
            say("%s-- Do you know if one of them is called Luca Lanister?\nMiner-- Unfortunately yes. Mr.Lanister is one of the trapped people.\nHe was the one overseeing the operation.\n",main_character.name);
            sleep(5);
            say("The miners look at each other and then at you.\nMiner-- Look kid, we are really sorry about your dad we are trying to move the rock as fast as we can. If you want to help us, go ahead but if you want to go back now is your chance.\n");
            main_character.HUNGER += 8;
            sleep(5);
            say("%s-- How did you know he is my dad?\nMiner-- A kid in the mines at this hour is pretty unusual.\nWe just put two and two together.\n",main_character.name);
            sleep(5);

            choice = get_input("Should I help the miners or go back home to Mom? (Help/Back)\n");
            
            if (strcmp(choice,"Help")== 0){
                say("I will help you move the rock to save my Dad and the other trapped people.\n");
                sleep(5);
                say("As the team finnaly moves the rock you fall into the purple crystal hole that looks like a weird passage or portal.\n");
                
            }
            else if (strcmp(choice,"Back")== 0){
                say("I have to see how Mom's doing.\nAs you turn around to leave ,disapointed, you are called by someone.\nThe miners finally removed the rock!!\nYou are distracted and trip, falling into the purple crystal portal.\n");
                
            }
    }
    else if (strcmp(choice,"Mom")== 0){
        story->Path = 2;
        say("%s-- You're right Mom. I'm sorry. Let's wait for the police together.\n-- I love you.\n",main_character.name);
        sleep(7);
        say("You stay with your Mom and try to comfort her as best as you can.\nThe police arrive a few hours later and start investigating your Dad's disappearance.\n");
        sleep(7);
        say("You tell them everything you know and they promise to do their best to find him.\nThe next day, the police imform you that they will search the mine your Dad was working at since it's the last place he was seen.\n");
        sleep(5);
        say("You insist on going and your mom decides to come with you to keep you safe.\nBecause the police needs someone that knows your Dad to identify him if they find him, they let you both go.\n");
        sleep(5);
        say("At the mine entrance, you see the security guards and explain the situation to them.\nThey let you in and one of them comes with you.\nAs you advance in the tunnels, you start to see a purple light that illuminates the cave.\n");
        sleep(6);
        say("You keep going and the light gets stronger and stronger until you reach a big cavern where you see a group of people that have removed a big rock off what seems to be the light's source.\n");
        sleep(5);
    ...
    case Chapter_2:{
        ...
        if (rival.ID < 0) {
            say("Error: rival NPC not found for id %d.\n", rival_id);
            rival = (NPC){0};
        }

        say("-------------------------\nChapter 2: A New World!\n-------------------------\n");
        sleep(1);
        say("%s-- Where am I? This place looks... strange.\nYou look around and see that you are in a huge grassy field.\n",main_character.name);
        sleep(5);
        say("You see some strange plants and creatures around you.\nThe sky is a weird shade of purple and there are two suns in the sky.\n");
        sleep(5);
        say("%s --What... is this place?\nYou start to walk around trying to find any sign of civilization or your Dad.\n",main_character.name);
        sleep(5);
        if (story->Path == 1){//You came alone
            say("%s-- Dad? Where are you?\nYou call out for your Dad but there's no answer.\n",main_character.name);
            sleep(5);
            say("You start to feel a bit uneasy.\nYou check your backpack\n");
            sleep(5);
            say("***This is the inventory. When in action you can access it anytime by typing 'I'.***\n");
            sleep(5);
            say("When inside the inventory you can use an item by typing its number.\nFor example, to use the first item in the list, type '1'.\n");
            sleep(2);
            say("If the item is consumable it will be eaten lowering your hunger imediatly.\nIf it's equippable you will equip it.\nIf you alredy have an item equiped on that slot you will switch them.\n");
            say("Type 'q' to exit the inventory.\n");
            sleep(5);
            open_inventory(&main_character);
            sleep(5);
            say("You keep walking and exploring the area hoping to find some clue about where you are or where your Dad is.\n");

            sleep(5);
        }
        else if(story->Path == 2){//You are with Mom
            say("%s-- Mom? Are you here?\nMOM!!\nYou call out for your Mom but there's no answer.\n",main_character.name);
            sleep(5);
            say("It seems even though you went through the portal together, you got separated somehow.\n");
            sleep(5);
            say("You start to feel a bit uneasy.\nYou check your backpack");
            say("***This is the inventory. When in action you can access it anytime by typing 'I'.***\n");
            sleep(5);
            ...
            say("Type 'q' to exit the inventory.\n");
            open_inventory(&main_character);
            say("You keep walking and exploring the area hoping to find some clue about where you are or where your Mom is.\n");
            sleep(5);
        }
        else{
        ...
        sleep(3);
        say("Teacher-- I see we have a new student here today!! Welcome to the academy!!\n%s-- Thank you!\nTeacher-- So, you have any experience with fighting and magic or right?\n%s-- No, not really.\nTeacher-- Oh, really weird since the academy starts at 10 yo and you seem way older than that. But don't worry, we will help you get used to this place and teach you everything you need to know.\n",main_character.name,main_character.name);
        sleep(5);
        if (story->Path == 1){
            say("You think to yourself, 'If things work how the teacher said, I think I will have to learn a lot and become stronger if I want to find my Dad'.\nWhat a mess.\n");
        }
        else if (story->Path == 2){
            say("You think to yourself, 'If things work how the teacher said, I think I will have to learn a lot and become stronger if I want to find my parents'.\nWhat a mess.\n");
        }
        sleep(3);
        say("Teacher-- Now I'm going to call Lilly and Mark to demonstrate combat and then I will choose pairs of students to try some combat.\nLilly and Mark go to the center of the room and start demonstrating some basic combat techniques.\n");
        sleep(4);
        say("Teacher-- Ok,now Marta and Laura,...,%s and %s, since you are the only 15 year-olds, you are going to fight each other!!\nI am being paired with a (kinda good looking... What am I thinking, focus!) student  and we start fighting each other.\n",main_character.name,main_character.name);
        sleep(4);
