...
const Abilities ALL_abilities[TOTAL_ABILITIES] = {
    {0, "Fire Punch", 20, D, Learned, "A fire attack that deals damage based on your magic power.", 0, "-5 HP", PLUS},
    {1, "Speed Boost", 30, D, Learned, "Temporarily doubles your speed for the duration of the fight.", 0, "2 SPEED", BOOST},
    {2, "Shield Bash", 10, D, Learned, "Deals damage and slightly increases your defence.", 0, "1.1 DEFENCE", BOOST},
    {3, "Lethal Punch Barrage", 25, C, Learned, "Deals heavy damage but reduces your damage.", 0, "0.75 DAMAGE", BOOST},
    {4, "Disguise", 30, C, Learned, "Increases your stealth, making it harder for enemies to hit you.", 0, "1.5 STEALTH", BOOST},
    {5, "Fire Bolt", 15, D, Learned, "Deals fire damage.", 0, "", NONE},
    {6, "Basic Healing", 20, D, Learned, "Heals a small amount of HP.", 0, "", HEAL},
    {7, "Group Healing", 30, B, Learned, "Heals you and your allies.", 0, "15 0", GROUP},
    {8, "Shadow Dog Summon", 80, C, Minamoto, "Summons a Shadow Dog to fight alongside you.", 0, "100", SUMMON},
    {9, "Strength Boost", 30, D, Learned, "Temporarily increases your damage for the duration of the fight.", 0, "1.5 DAMAGE", BOOST},
    {10, "Invisibility", 200, S, Learned, "Grants invisibility, greatly increasing your stealth.", 0, "7 STEALTH", BOOST},
    {11, "Fire Spirit Summon", 50, E, Learned, "Summons a Fire Spirit to fight alongside you.", 0, "101", SUMMON},
    {12, "Mana Infusion", 30, D, Learned, "Infuses your weapon or hands with mana, increasing its damage based on your magic power.", 0, "", NONE},
...
Ability_Class get_ability_class(int ability_id) {
    switch (ability_id) {
        case 2:
        case 3:
            return AbilityClass_Melee;
        case 12:
            return AbilityClass_Infused;
        case 8:
        case 11:
            return AbilityClass_Summon;
        case 7:
            return AbilityClass_Support;
        default:
            return AbilityClass_Magic; // Default caster-type for remaining abilities
    }
}

EFFECT_TYPE get_ability_effect_type(int ability_id) {
    switch (ability_id) {
        case 1: return BOOST; // Speed Boost
        case 2: return BOOST; // Shield Bash defence buff
        case 3: return BOOST; // Lethal Punch Barrage self-nerf
        case 4: return BOOST; // Disguise stealth boost
        case 7: return GROUP; // Group Healing heals team
        case 8: return SUMMON; // Shadow Dog Summon
        case 9: return BOOST; // Strength Boost
        case 10: return BOOST; // Invisibility stealth boost
        case 11: return SUMMON; // Fire Spirit Summon
        case 6: return HEAL; // Basic Healing
        default: return NONE;
    }
}
